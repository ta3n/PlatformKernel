namespace Liberty.Reservation.Application.Constants;
...
public enum ReservationStatus
{
    ...
    /// <summary>予約完了状態</summary>
    Confirmed,

    /// <summary>キャンセル済</summary>
    Canceled,

    /// <summary>変更され新しい予約となった</summary>
    Modified,

    /// <summary>オンライン決済未承認</summary>
    PaymentNotApproved,

    /// <summary>NoShow</summary>
    NoShow,

    /// <summary>編集中であるステータス※</summary>
    Modifing
}
...
{
    /// <summary>ログイン状態チェック</summary>
    public const string AuthorityChecker = "AuthorityChecker";

    /// <summary>ログアウト</summary>
    public const string AuthorityLogout = "AuthorityLogoutHandler";
}

public static class Roles
{
    public const string Admin = "Admin";
    public const string IppanUser = "IppanUser";
    public const string Facility = "Facility";
    public const string Staff = "Staff";
    public const string Kakusan = "Kakusan";
