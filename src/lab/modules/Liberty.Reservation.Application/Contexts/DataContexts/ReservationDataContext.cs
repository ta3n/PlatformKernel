...
) : AppDbContextBase<ReservationDataContext>(options, httpContextAccessor)
{
    // Datas
    ...
    public DbSet<FaxService> FaxServises { get; set; }
    ...
    public DbSet<ApplicationUserLoginHistory> ApplicationUserLoginHistories { get; set; }
    ...
    public DbSet<FacilityApplicationUser> FacilityApplicationUsers { get; set; }
