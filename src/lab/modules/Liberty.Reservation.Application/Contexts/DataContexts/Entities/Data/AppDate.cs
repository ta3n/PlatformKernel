...
public class AppDate : EntityData
{
    ...
    )
    {
        ...
        var yearStr = idStr.Substring(0, 4);
        var monthStr = idStr.Substring(4, 2);
        var dayStr = idStr.Substring(6, 2);
        //
        return new DateTime(ConvertUtil.ToInt(yearStr), ConvertUtil.ToInt(monthStr), ConvertUtil.ToInt(dayStr));
    }
    ...
    // public List<AppCalendarData> MCalendarDatas
    // {
    //     get {
    //         if (this.AppCalendarAppCalendarDatas == null) { return new List<AppCalendarData>(); }
    //         //
    //         return this.AppCalendarAppCalendarDatas
    //             .Select(a => a.AppCalendarData)
    //             .ToList();
    //     }
    // }
}
