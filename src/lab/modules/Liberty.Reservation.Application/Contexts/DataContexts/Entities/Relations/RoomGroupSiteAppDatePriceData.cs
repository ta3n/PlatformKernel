...
/// 部屋売料金体系
/// </summary>
public class RoomGroupSiteAppDatePriceData : EntityRelation
{
    /// <summary>
    /// 部屋ID
    /// </summary>
    ...
    public Facility? Facility => RoomGroup?.FacilityRoomGroups?.Select(a => a.Facility).FirstOrDefault();

    public RoomGroupSiteAppDatePriceData()
    {
    }
