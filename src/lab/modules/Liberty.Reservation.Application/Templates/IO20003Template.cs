...
{
    public IO20003TemplateFormat Format { get; private set; } = format;
    ...
    public string ReservationDetail()
    {
        ...
        var listOfData = Reservation?.ReservationData?.ReservationPlanRoomGroupAppDates;
        var appDateIds = listOfData?
...
public class IO20003TemplateFormat
{
