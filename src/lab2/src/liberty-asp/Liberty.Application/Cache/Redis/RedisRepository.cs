...
public class RedisBasketRepository : IRedisRepository
{
    ...
    public async Task Set(string key, object value, TimeSpan cacheTime)
    {
        if (value != null)
        {
            ...
            {
                // String does not need to be serialized
                await _database.StringSetAsync(key, cacheValue, cacheTime);
            }
            else
            {
                //Serialization, generate object value into RedisValue
                await _database.StringSetAsync(key, SerializeUtil.Serialize(value), cacheTime);
            }
        }
    }
    ...
    public async Task<TEntity> Get<TEntity>(string key)
    {
        ...
        if (value.HasValue)
        {
            //Need to use deserialization, deserialize the Byte[] stored in Redis
            return SerializeUtil.Deserialize<TEntity>(value);
        }
        else
        {
            return default;
    ...
    /// <summary>
    /// Insert a value at the head of the list. If the key does not exist, create it first and then insert the value
    /// </summary>
    /// <param name="redisKey"></param>
    ...
    /// <summary>
    /// Insert an array collection at the end of the list. If the key does not exist, create it first and then insert the value
    /// </summary>
    /// <param name="redisKey"></param>
    /// <param name="redisValue"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Removes and returns the first element stored in the list with this key Deserialize
    /// </summary>
    /// <param name="redisKey"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Removes and returns the last element stored in the list with this key Deserialize
    /// 只能是对象集合
    /// </summary>
    /// <param name="redisKey"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Removes and returns the first element stored in the list with this key  
    /// </summary>
    /// <param name="redisKey"></param>
    /// <param name="db"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Removes and returns the last element stored in the list with this key 
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="redisKey"></param>
    /// <param name="db"></param>
    ...
    /// <summary>
    /// Returns the element corresponding to the key in this list
    /// </summary>
    /// <param name="redisKey"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Get specified location data based on index
    /// </summary>
    /// <param name="redisKey"></param>
    ...
    /// <summary>
    /// Delete elements in List and return the number deleted
    /// </summary>
