    ...
    )
    {
        var updateHandle = updateAction
            ...
            ) =>
            {
                ...
                if (existingEntity.TimeZone is null)
                {
                    existingEntity.TimeZone = updateEntity.TimeZone;
                    existingEntity.TimeZoneId = updateEntity.TimeZoneId;
                }
    ...
    )
    {
        var updateHandle = updateAction
            ...
            ) =>
            {
                ...
                existingEntity.IsExtendedStayOnModify = updateEntity.IsExtendedStayOnModify;
                return existingEntity;
            });
