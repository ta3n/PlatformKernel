...
using Liberty.Reservation.Manager.File.WebAPI.Test.Configuration;
...
using IStartup = Liberty.Reservation.Manager.File.WebAPI.Startup.IStartup;
    ...
    where TEntryPoint : class, IStartup, new()
{
    ...
    {
        builder
            .UseSolutionRelativeContentRoot("src/services/manager/Liberty.Reservation.Manager.File.WebAPI")
            .ConfigureServices(
                services =>
                {
