...
public record ReservationDetailResponse
{
    ...
    public string? FacilityTimeZoneId { get; init; }
    public TimeSpan? FacilityTimeZone { get; init; }
    public ReservationStatus State { get; init; }
    public CancellationStatus CancellationStatus { get; init; }
    public CancellationFeeType CancellationFeeType { get; init; }
    ...
    public bool IsManagerNoShow { get; init; }
    public bool IsFacilityOnlySetOnlinePaymentMethod { get; init; }
    public bool DayUse { get; init; }
    public DateTime? UpdatedAt { get; init; }
    public int UpdateCount { get; init; }
    public DateTime? CancellationDate { get; init; }
    public float? CancellationRate { get; init; }
    public string? CancellationRule { get; init; }
    public bool IsExtendedStayOnModify { get; init; }
}
