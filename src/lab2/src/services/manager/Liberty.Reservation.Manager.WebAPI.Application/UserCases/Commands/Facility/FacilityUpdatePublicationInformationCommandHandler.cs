...
public class FacilityUpdatePublicationInformationCommandHandler(
    IUnitOfWork unitOfWork,
    IMapper mapper,
    ISecurityContextAccessor securityContextAccessor,
    IFacilityService facilityService
) : UpdateCommandHandlerBase<FacilityUpdatePublicationInformationCommand, long>(unitOfWork, mapper)
{
    protected override async Task<long> HandleAsync(
        FacilityUpdatePublicationInformationCommand request,
    ...
    )
    {
        ...
        var editFacility = await facilityService.UpdatePublicationInformationAsync(
            entityToUpdate,
            cancellationToken: cancellationToken
        );
