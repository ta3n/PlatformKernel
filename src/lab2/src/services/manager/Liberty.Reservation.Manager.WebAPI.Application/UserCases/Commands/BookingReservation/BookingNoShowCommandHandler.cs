...
) : UpdateCommandWithAuditEventHandlerBase<BookingNoShowCommand, long>(unitOfWork, mapper, mediator)
{
    ...
    )
    {
        ...
        var canManagerModify = BookingModificationCheckerService.CanNoShowModify(
            ...
            existingReservation!.Facility!.TimeZone
        );
        if (!canManagerModify)
        {
        ...
        var dateNow = DateTime.UtcNow.Add(timeZone);
        ...
        try
        {
            ...
            AuditEventData = new BookingNoShowEvent
            {
