...
public static class SwaggerStartup
{
    ...
    )
    {
        services.AddSwaggerGen(
            options =>
            {
                options.OperationFilter<PageableIncludeSortModelFilter>();
...
public class FacilitySelectHeaderParameter : IOperationFilter
{
    ...
    )
    {
        ...
        if (description.RelativePath?.Contains("api/profile") ?? false)
        {
            return;
        }
        ...
        operation.Parameters.Add(
            ...
            {
                Name = SecurityContextAccessor.FacilityHeaderKey,
                In = ParameterLocation.Header,
