...
public class MediaCategoriesEndpointUnitTest : BaseCategoriesEndpointUnitTest
{
    [Fact]
    public async Task CreateMediaCategory_ReturnsCorrectResult()
    {
        // Arrange
        ...
        var controller = new MediaCategoriesEndpoint(
            mockMapper,
            MockCategoryService,
    ...
    [Fact]
    public async Task UpdateMediaCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnableMediaCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnableMediaCategory_ReturnAppRequestInvalidException()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task DeleteMediaCategory_ReturnsCorrectResult()
    {
        // Arrange
        var categoryId = 2;
        var category = new Category
    ...
    [Fact]
    public async Task GetMediaCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task GetAllMediaCategories_ReturnsCorrectResult()
    {
        // Arrange
    ...
    [Fact]
    public async Task ArrangeOrderOfMediaCategories_ReturnsCorrectResult()
    {
