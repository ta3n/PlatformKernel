...
public class PlanCategoriesEndpointUnitTest : BaseCategoriesEndpointUnitTest
{
    [Fact]
    public async Task CreatePlanCategory_ReturnsCorrectResult()
    {
        // Arrange
        ...
        var controller = new PlanCategoriesEndpoint(
            mockMapper,
            MockCategoryService,
    ...
    [Fact]
    public async Task UpdatePlanCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnablePlanCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnablePlanCategory_ReturnAppRequestInvalidException()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task DeletePlanCategory_ReturnsCorrectResult()
    {
        // Arrange
    ...
    [Fact]
    public async Task GetPlanCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task GetAllPlanCategories_ReturnsCorrectResult()
    {
        // Arrange
    ...
    [Fact]
    public async Task ArrangeOrderOfPlanCategories_ReturnsCorrectResult()
    {
