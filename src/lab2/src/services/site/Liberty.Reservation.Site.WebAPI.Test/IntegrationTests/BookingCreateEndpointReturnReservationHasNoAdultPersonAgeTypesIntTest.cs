...
public class BookingCreateEndpointReturnReservationHasNoAdultPersonAgeTypesIntTest : BaseIntegrationTest
{
    private static string BaseUrl => "api/booking";

    private GetBookingData GetBookingData { get; }

    public BookingCreateEndpointReturnReservationHasNoAdultPersonAgeTypesIntTest()
    {
        GetBookingData = new GetBookingData(Factory, Client);
    }

    [Fact]
    public async Task BookingCreate_ReturnReservationNoMatchPersonsException()
    {
        ...
        try
        {
            var exception = JsonConvert.DeserializeObject<ReservationHasNoAdultPersonAgeTypesException>(json);
