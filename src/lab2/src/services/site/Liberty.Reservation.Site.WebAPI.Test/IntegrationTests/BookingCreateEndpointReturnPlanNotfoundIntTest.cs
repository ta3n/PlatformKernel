...
public class BookingCreateEndpointReturnPlanNotfoundIntTest : BaseIntegrationTest
{
    private static string BaseUrl => "api/booking";

    private GetBookingData GetBookingData { get; }

    public BookingCreateEndpointReturnPlanNotfoundIntTest()
    {
        GetBookingData = new GetBookingData(Factory, Client);
    }

    [Fact]
    public async Task BookingCreate_PlanNotfoundException()
    {
        ...
        var url = BaseUrl + "/plans/1000/rooms/1000";
        ...
        try
        {
            var exception = JsonConvert.DeserializeObject<PlanNotfoundException>(json);
