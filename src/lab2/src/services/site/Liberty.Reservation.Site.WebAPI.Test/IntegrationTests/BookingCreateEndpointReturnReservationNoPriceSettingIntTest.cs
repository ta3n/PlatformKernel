...
public class BookingCreateEndpointReturnReservationNoPriceSettingIntTest : BaseIntegrationTest
{
    private static string BaseUrl => "api/booking";

    private GetBookingData GetBookingData { get; }

    public BookingCreateEndpointReturnReservationNoPriceSettingIntTest()
    {
        GetBookingData = new GetBookingData(Factory, Client);
    }

    [Fact]
    public async Task CreateBooking_ReservationNoPriceSettingException()
    {
        ...
        try
        {
            var exception = JsonConvert.DeserializeObject<ReservationNoPriceSettingException>(json);
