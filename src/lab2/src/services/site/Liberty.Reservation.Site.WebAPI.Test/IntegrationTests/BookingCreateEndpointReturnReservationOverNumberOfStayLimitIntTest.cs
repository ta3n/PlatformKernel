...
public class BookingCreateEndpointReturnReservationOverNumberOfStayLimitIntTest : BaseIntegrationTest
{
    private static string BaseUrl => "api/booking";

    private GetBookingData GetBookingData { get; }

    public BookingCreateEndpointReturnReservationOverNumberOfStayLimitIntTest()
    {
        GetBookingData = new GetBookingData(Factory, Client);
    }

    [Fact]
    public async Task BookingCreate_ReturnReservationOverNumberOfStayLimitException()
    {
        ...
        try
        {
            var exception = JsonConvert.DeserializeObject<ReservationOverNumberOfStayLimitException>(json);
