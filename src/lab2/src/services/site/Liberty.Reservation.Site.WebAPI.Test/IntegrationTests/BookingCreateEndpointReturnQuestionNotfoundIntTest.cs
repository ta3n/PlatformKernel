...
public class BookingCreateEndpointReturnQuestionNotfoundIntTest : BaseIntegrationTest
{
    private static string BaseUrl => "api/booking";

    private GetBookingData GetBookingData { get; }

    public BookingCreateEndpointReturnQuestionNotfoundIntTest()
    {
        GetBookingData = new GetBookingData(Factory, Client);
    }

    [Fact]
    public async Task BookingCreate_ReturnQuestionNotfoundException()
    {
        ...
        var questionOfBookingReq = new QuestionOfBookingCreateRequest(
            1000,
            ""
        );
        ...
        try
        {
            var exception = JsonConvert.DeserializeObject<QuestionNotfoundException>(json);
