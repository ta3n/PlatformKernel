    ...
    )
    {
        services.AddSwaggerGen(
            options =>
            {
                ...
                options.OperationFilter<TimeZoneSelectHeaderParameter>();
                options.OperationFilter<FacilitySelectHeaderParameter>();
...
public class FacilitySelectHeaderParameter : IOperationFilter
{
    public void Apply(
    ...
    )
    {
        ...
        if (description.GroupName != "v1" && description.RelativePath != "api/reservation/employee/destinations")
        {
            return;
        }
        ...
        operation.Parameters.Add(
            ...
            {
                Name = AppContracts.FacilityCodeHeaderKey,
                In = ParameterLocation.Header,
        ...
        operation.Parameters.Add(
            new OpenApiParameter
            {
                Name = AppContracts.SiteCodeOfFacilityHeaderKey,
                In = ParameterLocation.Header,
...
public class TimeZoneSelectHeaderParameter : IOperationFilter
{
    public void Apply(
        OpenApiOperation operation,
        OperationFilterContext context
    )
    {
        operation.Parameters.Add(
            new OpenApiParameter
            {
                Name = AppContracts.TimeZoneOffsetHeaderKey,
                In = ParameterLocation.Header,
                Description = "Time zone header",
                Schema = new OpenApiSchema
                {
                    Type = "number",
                    Default = new OpenApiString("9")
                },
                Required = true
            }
        );
