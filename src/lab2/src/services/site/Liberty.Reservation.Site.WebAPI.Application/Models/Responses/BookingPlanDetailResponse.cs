...
public record BookingPlanDetailResponse
{
    ...
    public IEnumerable<MealOfBookingResponse> Meals { get; set; } = [];
    public IEnumerable<QuestionOfBookingResponse> Questions { get; set; } = [];
    public IEnumerable<PersonAgeTypeOfBookingFacilityResponse> PersonAgeTypes { get; set; } = [];
    public bool IsAvailableBookingReception { get; set; }
}
