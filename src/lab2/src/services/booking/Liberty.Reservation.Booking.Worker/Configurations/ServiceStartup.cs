...
public static class ServiceStartup
{
    ...
    )
    {
        ...
        services.AddScoped<IBookingAggregateAuditLogService, BookingAggregateAuditLogService>();
        services.AddScoped<IBookingAuditCompareService, BookingAuditCompareService>();
        services.AddScoped<IBookingAggregateMailAuditLogService, BookingAggregateMailAuditLogService>();
        services.AddScoped<IBookingAggregateFaxAuditLogService, BookingAggregateFaxAuditLogService>();
        services.AddScoped<IBookingReservationService, BookingReservationService>();
