...
public class ReservationGetAllReservationsEndpointIntTest : BaseReservationEndpointIntTest
{
    [Fact]
    public async Task Reservation_GetAllReservations_ReturnOK_WithListReservationResponse()
    {
