...
public class GetAllPersonAgeTypesOfReservationEndpointIntTest : BaseReservationEndpointIntTest
{
    [Fact]
    public async Task GetAllPersonAgeTypes_ReturnOK_WithPersonAgeTypes()
    {
