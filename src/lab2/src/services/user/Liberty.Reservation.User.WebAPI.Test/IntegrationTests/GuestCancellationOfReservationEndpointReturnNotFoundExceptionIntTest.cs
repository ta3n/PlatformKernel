...
public class GuestCancellationOfReservationEndpointReturnNotFoundExceptionIntTest : BaseReservationEndpointIntTest
{
    private static new string BaseUrl => "api/guest/booking";

    [Fact]
    public async Task Guest_CancellationOfReservation_ReturnReservationCancellationNotFoundException()
    {
