...
public class CreateGmoPaymentSuccessfulTransactionEndpointReturnsExpectedResponseIntTest : BaseReservationEndpointIntTest
{
    [Fact]
    public async Task CreateGMOPayment_SuccessfulTransaction_ReturnsExpectedResponse()
    {
    ...
    )
    {
        ...
        const string shopId = "tshop00070472";
        const string shopPass = "7fxt2avb";
        ...
        var gmoPaymentRequest = new GmoPaymentRequest
        {
            ...
            OrderId = execTranResponse.OrderId,
            Status = "CAPTURE",
            JobCd = jobCd,
            Amount = $"{amount}",
            Tax = $"{tax}",
