...
public class GuestGetAllOptionItemsEndpointReturnReservationNotfoundExceptionIntTest : BaseReservationEndpointIntTest
{
    private static new string BaseUrl => "api/guest/booking";

    [Fact]
    public async Task Guest_GetAllOptionItems_ReturnReservationNotfoundException()
    {
