...
public record ReservationDetailResponse
{
    ...
    public string? FacilityTimeZone { get; init; }
    ...
    public long CheckOutDate
    {
        get
        {
            var checkOutDate = AppDate.GetId(AppDate.GetDateTime(CheckInDate, new TimeSpan(0, 0, 0)).Add(DefaultValues.DefaultTimeZoneOffset).AddDays(NumberOfNights));
            return checkOutDate;
        }
    }
