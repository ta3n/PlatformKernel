...
public class RoomGroupEquipmentCategoriesEndpointUnitTest : BaseCategoriesEndpointUnitTest
{
    [Fact]
    public async Task CreateRoomGroupEquipmentCategory_ReturnsCorrectResult()
    {
        // Arrange
        ...
        var controller = new RoomGroupEquipmentCategoriesEndpoint(mockMapper, MockMediator, MockCategoryService);
    ...
    [Fact]
    public async Task UpdateRoomGroupEquipmentCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnableRoomGroupEquipmentCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task DeleteRoomGroupEquipmentCategory_ReturnsCorrectResult()
    {
        // Arrange
        var categoryId = 2;
        var category = new Category
    ...
    [Fact]
    public async Task GetRoomGroupEquipmentCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task GetAllRoomGroupEquipmentCategories_ReturnsCorrectResult()
    {
        // Arrange
