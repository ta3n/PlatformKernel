...
public class LeisureCategoriesEndpointUnitTest : BaseCategoriesEndpointUnitTest
{
    [Fact]
    public async Task CreateLeisureCategory_ReturnsCorrectResult()
    {
        // Arrange
        ...
        var controller = new LeisureCategoriesEndpoint(mockMapper, MockMediator, MockCategoryService);

        // Act
        var result = await controller.CreateCategory(categoryCreateRequest, CancellationToken.None);
    ...
    [Fact]
    public async Task UpdateLeisureCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnableLeisureCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
        ...
        var controller = new LeisureCategoriesEndpoint(mockMapper, mockMediator.Object, MockCategoryService);
        var cancellationToken = CancellationToken.None;
    ...
    [Fact]
    public async Task EnableLeisureCategory_ReturnAppRequestInvalidException()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task DeleteLeisureCategory_ReturnsCorrectResult()
    {
        // Arrange
        var categoryId = 2;
        var category = new Category
    ...
    [Fact]
    public async Task GetLeisureCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task GetAllLeisureCategories_ReturnsCorrectResult()
    {
        // Arrange
