...
public class DestinationsEndpointIntTest : BaseIntegrationTest
{
    ...
    {
        var responseString = await CreateDestinationAsync("AA");
    ...
    {
        var newDestination1 = await CreateDestinationAsync("AA");
        _ = long.TryParse(newDestination1, out var newDestinationId1);

        var newDestination2 = await CreateDestinationAsync("BB");
    ...
    {
        var destinationId = await CreateDestinationAsync("AB");
    ...
    {
        var destinationId = await CreateDestinationAsync("CC");
    ...
    {
        var destinationId = await CreateDestinationAsync("AC");
    ...
    {
        await CreateDestinationAsync("DE");
    ...
    {
        await CreateDestinationAsync("EF");
    ...
    {
        var destinationId = await CreateDestinationAsync("FG");
