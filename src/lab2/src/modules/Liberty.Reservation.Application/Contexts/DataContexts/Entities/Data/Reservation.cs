...
public class Reservation : EntityData
{
    ...
    )
    {
        ...
        var timeZoneOffset = Facility?.TimeZone ?? DefaultValues.DefaultTimeZoneOffset;

        var now = DateTime.UtcNow.Add(timeZoneOffset);
        ...
        var minDate = limit < checkInDate ? limit : checkInDate;
