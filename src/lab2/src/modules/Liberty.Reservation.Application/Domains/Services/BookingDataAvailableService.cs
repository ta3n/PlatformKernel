                    ...
                    .Select(
                        y => new OptionItemAppDate
                        {
                            ...
                            OptionItem = new OptionItem
                            {
                                ...
                                MaxSupplyNumber = y.OptionItem!.MaxSupplyNumber,
                                Price = y.OptionItem!.Price
                            },
                            ReservationRoomGroupAppDateOptionItems = x.ReservationRoomGroupAppDateOptionItems!
                                .Where(
                                    t => t.Reservation!.CheckInDate + t.RestIndex == y.AppDateId && t.ReservationId != ignoreReservationId
                                )
                                .Where(
                                    t =>
                ...
                .Select(
                    x => new ReservationEntity
                    {
                        ...
                        Facility = new Facility
                        {
                            ...
                            IsExtendedStayOnModify = x.Facility.IsExtendedStayOnModify,
                            TimeZone = x.Facility.TimeZone,
                            TimeZoneId = x.Facility.TimeZoneId
                        },
