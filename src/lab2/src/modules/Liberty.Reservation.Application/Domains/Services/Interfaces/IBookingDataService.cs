...
{
    /// <summary>
    /// Retrieves booking data based on the provided reservation, booking plan, reservation price data,
    /// selected questions, and booking cancellation policy model.
    /// </summary>
    ...
    /// This parameter is optional and can be null.
    /// </param>
    /// <param name="bookingCancellationPolicyModel">
    /// The booking cancellation policy model that provides details about the cancellation policy.
    /// This parameter is optional and can be null.
    /// </param>
