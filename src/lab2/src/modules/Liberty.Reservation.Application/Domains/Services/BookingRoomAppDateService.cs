...
) : IBookingRoomAppDateService
{
    ...
    )
    {
        ...
        sb.Append("    ").Append(EscapeColumn(_roomGroupAppDateProp.ColumnName(nameof(RoomGroupAppDate.RoomGroupId))));
        sb.Append(", ");
        sb.Append(EscapeColumn(_roomGroupAppDateProp.ColumnName(nameof(RoomGroupAppDate.AppDateId))));
        sb.AppendLine(")");
    ...
    )
    {
        ...
        sb.AppendLine(compiled.Sql);
        sb.AppendLine("ON CONFLICT (");
        sb.Append("    ").Append(EscapeColumn(_appDateProp.ColumnName(nameof(AppDate.Id))));
        sb.AppendLine(")");
        sb.AppendLine("DO UPDATE SET");
        sb.AppendLine(
            string.Join(
