...
public class BookingReservationPriceDataOfPlanService(
    IBookingReservationService bookingReservationService
) : IBookingReservationPriceDataService
{
    ...
    )
    {
        ...
        var facilityTimeZone = bookingReservationService.GetFacilityTimeZoneById(bookingCreateRequest.FacilityId);
    ...
    protected TimeSpan GetFacilityTimeZone(
        long facilityId
    )
    {
        return bookingReservationService.GetFacilityTimeZoneById(facilityId);
    }
    ...
    )
    {
        ...
        var isAvailable = bookingPlanAvailable.CanDisplayDate(appDateId)
            ...
            && bookingPlanAvailable.IsReceptionAvailable(appDateId, checkInDate, false, facilityTimeZone, isNotCheckValidDateLimit);
