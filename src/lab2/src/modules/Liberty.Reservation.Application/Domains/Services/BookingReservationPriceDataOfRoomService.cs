...
public class BookingReservationPriceDataOfRoomService(
    IBookingReservationService bookingReservationService
) : BookingReservationPriceDataOfPlanService(bookingReservationService), IBookingReservationPriceDataService
{
    ...
    )
    {
        ...
        var facilityTimeZone = GetFacilityTimeZone(bookingCreateRequest.FacilityId);
