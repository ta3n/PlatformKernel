    ...
    public override string Body
    {
        get
        {
            ...
            var args = new FormatDictionary
            {
                ...
                {
                    "managerEditedDescription", ReservationOperationType == ReservationOperationTypes.Facility
                        ? "This reservation has been edited by the facility."
                        : ""
                },
