...
) : BaseTemplate
{
    ...
    public override string Body
    {
        get
        {
            ...
            var dayLeft = AppDate.GetDateTime(Reservation?.CheckInDate)?.Date - DateTime.UtcNow.Add(offset).Date;
            ...
            var args = new FormatDictionary
            {
                ...
                { "payOff", GetPayOff() },
                { "reservationDetailURL", URL != null && Reservation?.Id != null ? URL : null },
    ...
    public override List<MailTemplateParameter> GetMailTemplateParameters()
    {
        ...
        [
            ...
            MailParameter.CancelPeriod,
            MailParameter.ReservationDetailUrl,
            MailParameter.DayLeft
        ];
    }
