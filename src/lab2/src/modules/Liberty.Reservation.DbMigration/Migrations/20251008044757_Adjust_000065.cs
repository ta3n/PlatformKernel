...
{
    /// <inheritdoc />
    public partial class Adjust_000065 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "booking_aggregate_fax_audit_log",
                schema: "public",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_booking_aggregate_fax_audit_log", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "ix_booking_aggregate_fax_audit_log_code",
                schema: "public",
                table: "booking_aggregate_fax_audit_log",
                column: "code",
                unique: true);
        }
