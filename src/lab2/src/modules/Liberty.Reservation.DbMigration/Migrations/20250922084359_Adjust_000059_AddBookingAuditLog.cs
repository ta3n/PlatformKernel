...
{
    /// <inheritdoc />
    public partial class Adjust_000059_AddBookingAuditLog : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "booking_aggregate_audit_log",
                schema: "public",
                columns: table => new
                {
                    ...
                    request = table.Column<string>(type: "jsonb", nullable: true, defaultValueSql: "'{}'::jsonb"),
                    changed_fields = table.Column<string>(type: "jsonb", nullable: true, defaultValueSql: "'{}'::jsonb"),
                    user_code = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_booking_aggregate_audit_log", x => x.id);
                });


            migrationBuilder.CreateIndex(
                name: "ix_booking_aggregate_audit_log_code",
                schema: "public",
                table: "booking_aggregate_audit_log",
                column: "code",
                unique: true);
        }
