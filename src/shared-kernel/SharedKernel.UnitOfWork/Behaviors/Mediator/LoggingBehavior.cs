...
/// <summary>
/// Represents a behavior in the Mediator pipeline for logging information about
...
{
    /// <summary>
    /// Handles the logging behavior for a request and response lifecycle in the Mediator pipeline.
