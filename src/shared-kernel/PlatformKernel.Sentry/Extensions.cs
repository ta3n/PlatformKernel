...
using SentryOptions = PlatformKernel.Sentry.Options.SentryOptions;

namespace PlatformKernel.Sentry;

using Options_SentryOptions = Options.SentryOptions;
...
public static class Extensions
{
    ...
    )
    {
        ...
        var sentryOptions = section.Get<Options_SentryOptions>();

        builder.Services.Configure<Options_SentryOptions>(section);
