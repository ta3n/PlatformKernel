...
public abstract class CommandBaseHandler<TCommand, TResponse> : ICommandHandlerBase<TCommand, TResponse>
...
/// </remarks>
public abstract class CreateCommandHandlerBase<TCommand, TResponse> : CommandBaseHandler<TCommand, TResponse>,
...
/// </typeparam>
public abstract class UpdateCommandHandlerBase<TCommand, TResponse> : CommandBaseHandler<TCommand, TResponse>,
...
public abstract class DeleteCommandHandlerBase<TCommand, TResponse> : CommandBaseHandler<TCommand, TResponse>,
...
/// </remarks>
public abstract class ActionCommandHandlerBase<TCommand, TResponse> : CommandBaseHandler<TCommand, TResponse>,
