...
using BlueprintNormal.Domain.Entities;
using BlueprintNormal.Infrastructure.Data;
using BlueprintNormal.Infrastructure.Data.Repositories;
using BlueprintNormal.Security;
using BlueprintNormal.Security.Jwt;
using BlueprintNormal.Domain.Services;
...
using AuthenticationService = BlueprintNormal.Domain.Services.AuthenticationService;
using IAuthenticationService = BlueprintNormal.Domain.Services.Interfaces.IAuthenticationService;

namespace BlueprintNormal.Configuration;
