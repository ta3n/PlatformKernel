...
namespace BlueprintCqrs.Test.Controllers;
...
public class AccountResourceIntTest
{
    ...
    public async Task TestChangePasswordWrongExistingPassword()
    {
        ...
        passwordHasher.VerifyHashedPassword(updatedUser, updatedUser.PasswordHash, currentPassword)
            .Should()
            .Be(PasswordVerificationResult.Success);
    }
    ...
    public async Task TestGetExistingAccount()
    {
        ...
        json.SelectToken("$.authorities")
            .ToObject<IEnumerable<string>>()
            .Should()
            .Contain(new[] { RolesConstants.Admin });
    }
    ...
    public async Task TestRegisterAdminIsIgnored()
    {
        ...
        var validUser = new ManagedUserDto
        {
            ...
            ImageUrl = "http://placehold.it/50x50",
            LangKey = Constants.DefaultLangKey,
            Roles = new HashSet<string> { RolesConstants.Admin }
        };
