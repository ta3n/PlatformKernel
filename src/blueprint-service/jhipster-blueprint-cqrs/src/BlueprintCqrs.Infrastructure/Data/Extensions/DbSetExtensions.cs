...
namespace BlueprintCqrs.Infrastructure.Data.Extensions;

public static class DbSetExtensions
{
    public static EntityEntry<TEntity> RemoveById<TEntity>(
        this DbSet<TEntity> receiver,
        object id
    )
        where TEntity : class
    {
    ...
    public static void RemoveNavigationProperty<TEntity, TOwnerEntity>(
        this DbSet<TEntity> receiver,
    ...
    private static IQueryable<T> ApplyWhere<T>(
