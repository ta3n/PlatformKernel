...
public interface ITokenProvider
{
    ...
    ClaimsPrincipal TransformPrincipal(
...
public class TokenProvider : ITokenProvider
{
    ...
    public ClaimsPrincipal TransformPrincipal(
        ClaimsPrincipal principal
    )
    {
        ...
        var roleClaims = principal
            .Claims
            .Filter(it => it.Type == AuthoritiesKey)
            .First()
            .Value
            .Split(",")
    ...
    private static ClaimsIdentity CreateSubject(
        IPrincipal principal
    )
    {
        ...
        return new ClaimsIdentity(new[] { new Claim(JwtRegisteredClaimNames.Sub, username), new Claim(AuthoritiesKey, authValue) });
    }

    private static IEnumerable<Claim> GetRoles(
        IPrincipal principal
    )
    {
