...
public class BookingCreateLoginedForRoomEndpointIntTest : BaseIntegrationTest
{
    private static string BaseUrl => "api/booking";
    private GetBookingData GetBookingData { get; }

    public BookingCreateLoginedForRoomEndpointIntTest()
    {
    ...
    {
        var plan = await GetBookingData.GetPlan(true, PlanTypes.RoomOnly);
