...
public class ChangePersonBookingEndpointReturnPlanNotfoundIntTest : BaseIntegrationTest
{
    private const string BaseUrl = "api/booking";

    private GetBookingData GetBookingData { get; }

    public ChangePersonBookingEndpointReturnPlanNotfoundIntTest()
    {
        GetBookingData = new GetBookingData(Factory, Client);
    }

    [Fact]
    public async Task ChangePersonBooking_PlanNotfoundException()
    {
