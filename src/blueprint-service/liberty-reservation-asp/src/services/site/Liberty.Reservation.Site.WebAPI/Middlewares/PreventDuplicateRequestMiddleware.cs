...
) : BaseMiddleware
{
    ...
    [
        ...
        {
            Method = HttpMethods.Post,
            PathPattern = "*search-by-room*"
        },
        new()
        {
            Method = HttpMethods.Post,
            PathPattern = "*check-changed*"
        },
        new()
        {
            Method = HttpMethods.Post,
        ...
        {
            Method = HttpMethods.Post,
            PathPattern = "*check-night-number*"
        },
        new()
        {
            Method = HttpMethods.Post,
            PathPattern = "*check-room-number*"
        },
        new()
        {
            Method = HttpMethods.Post,
            PathPattern = "*change-persons*"
        },
        new()
        {
            Method = HttpMethods.Post,
            PathPattern = "*adjust-options*"
        }
    ];
