...
public class FacilityUpdateReservationSettingCommandHandler(
    IUnitOfWork unitOfWork,
    IMapper mapper,
    ISecurityContextAccessor securityContextAccessor,
    IFacilityService facilityService
) : UpdateCommandHandlerBase<FacilityUpdateReservationSettingCommand, long>(unitOfWork, mapper)
{
    protected override async Task<long> HandleAsync(
        FacilityUpdateReservationSettingCommand request,
    ...
    )
    {
        ...
        var editFacility = await facilityService.UpdateReservationSettingAsync(
            entityToUpdate,
            cancellationToken: cancellationToken
        );
