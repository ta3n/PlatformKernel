...
public class RoomGroupPricesUpdateSaleInfoEndpointIntTest : BaseIntegrationTest
{
    ...
    public async Task UpdateRoomGroupSale_ReturnNoContent()
    {
        ...
        var updateReq = new RoomGroupPriceUpdateSaleRequest
        {
        ...
        var response = await Client.PatchAsync(
            $"{BaseUrl}/{roomGroupId}/destinations/{site.Id}/sale",
    ...
    [Fact]
    public async Task GetRoomGroupSale_ReturnOKWithResponse()
    {
        var roomGroupIdString = await CreateRoomGroupAsync();
        _ = long.TryParse(roomGroupIdString, out var roomGroupId);
