...
public class ReservationPriceCalendarEndpointIntTest : BaseIntegrationTest
{
    private static string BaseUrl => "api/reservations";
    private MockBookingData MockBookingData { get; }

    public ReservationPriceCalendarEndpointIntTest()
    {
        MockBookingData = new MockBookingData(Factory, Client, FacilityInfo);
    }

    [Fact]
    public async Task GetReservationPriceCalendar_ReturnOk_WithBookingPriceCalendarResponse()
    {
