...
public class BookingGetOptionItemsEndpointIntTest : BaseIntegrationTest
{
    private static string BaseUrl => "api/reservations";
    private MockBookingData MockBookingData { get; }

    public BookingGetOptionItemsEndpointIntTest()
    {
        MockBookingData = new MockBookingData(Factory, Client, FacilityInfo);
    }

    [Fact]
    public async Task GetAllOptionItems_ReturnOK_WithOptionItemOfPlanResponse()
    {
