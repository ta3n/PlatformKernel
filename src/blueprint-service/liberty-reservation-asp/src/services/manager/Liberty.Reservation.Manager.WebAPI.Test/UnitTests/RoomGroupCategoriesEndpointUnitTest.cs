...
public class RoomCategoriesEndpointUnitTest : BaseCategoriesEndpointUnitTest
{
    [Fact]
    public async Task CreateRoomGroupCategory_ReturnsCorrectResult()
    {
        // Arrange
        ...
        var controller = new RoomCategoriesEndpoint(
            mockMapper,
            MockCategoryService,
    ...
    [Fact]
    public async Task UpdateRoomGroupCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnableRoomGroupCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnableRoomGroupCategory_ReturnAppRequestInvalidException()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task DeleteRoomGroupCategory_ReturnsCorrectResult()
    {
        // Arrange
        var categoryId = 2;
        var category = new Category
    ...
    [Fact]
    public async Task GetRoomGroupCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task GetAllRoomGroupCategories_ReturnsCorrectResult()
    {
        // Arrange
    ...
    [Fact]
    public async Task ArrangeOrderOfRoomGroupCategories_ReturnsCorrectResult()
    {
