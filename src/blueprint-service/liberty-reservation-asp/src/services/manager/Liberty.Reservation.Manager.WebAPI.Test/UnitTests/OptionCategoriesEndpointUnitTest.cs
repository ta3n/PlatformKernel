...
public class OptionCategoriesEndpointUnitTest : BaseCategoriesEndpointUnitTest
{
    [Fact]
    public async Task CreateOptionItemCategory_ReturnsCorrectResult()
    {
        // Arrange
        ...
        var controller = new OptionItemCategoriesEndpoint(
            mockMapper,
            MockCategoryService,
    ...
    [Fact]
    public async Task UpdateOptionItemCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnableOptionItemCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnableOptionItemCategory_ReturnAppRequestInvalidException()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task DeleteOptionItemCategory_ReturnsCorrectResult()
    {
        // Arrange
        var categoryId = 2;
        var category = new Category
    ...
    [Fact]
    public async Task GetOptionItemCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task GetAllOptionItemCategories_ReturnsCorrectResult()
    {
        // Arrange
        var categories = new List<Category>
        {
            new()
            {
                Id = 1,
                Code = "Code1",
                Name = new MultilingualText { { TestUtil.DefaultLanguageCode, "Category1" } },
                Description = new MultilingualText { { TestUtil.DefaultLanguageCode, "Description1" } }
            },
            new()
            {
                Id = 2,
                Code = "Code2",
                Name = new MultilingualText { { TestUtil.DefaultLanguageCode, "Category2" } },
                Description = new MultilingualText { { TestUtil.DefaultLanguageCode, "Description2" } }
            }
        };
    ...
    [Fact]
    public async Task ArrangeOrderOfOptionItemCategories_ReturnsCorrectResult()
    {
