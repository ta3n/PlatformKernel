...
namespace Liberty.Reservation.User.WebAPI.Test.InfrastructureOfTest.Utilities;

public static class TestUtil
{
    private static readonly Random Random = new();

    public static string DefaultLanguageCode { get; set; } = "ja";
    public static string DefaultAccpectLanguage { get; set; } = "ja";
