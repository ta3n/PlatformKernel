...
public class GuestGetAllPersonAgeTypesEndpointReturnReservationNotfoundExceptionIntTest : BaseReservationEndpointIntTest
{
    private static new string BaseUrl => "api/guest/booking";

    [Fact]
    public async Task Guest_GetAllPersonAgeTypes_ReturnReservationNotfoundException()
    {
