...
public class ReservationGetReservationDetailsEndpointIntTest : BaseReservationEndpointIntTest
{
    [Fact]
    public async Task Reservation_GetReservationDetails_ReturnOK_WithReservationResponse()
    {
