...
public class ReservationGetAllOptionItemsEndpointReturnReservationNotfoundExceptionIntTest : BaseReservationEndpointIntTest
{
    [Fact]
    public async Task Reservation_GetAllOptionItems_ReturnReservationNotfoundException()
    {
