...
public class ReservationCheckNumberOfNightsReservationNotfoundExceptionIntTest : BaseReservationEndpointIntTest
{
    [Fact]
    public async Task Reservation_CheckNumberOfNights_ReservationNotfoundException()
    {
