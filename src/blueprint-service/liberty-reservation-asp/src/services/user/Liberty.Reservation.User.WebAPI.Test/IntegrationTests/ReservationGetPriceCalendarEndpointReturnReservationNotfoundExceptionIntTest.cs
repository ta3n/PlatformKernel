...
public class ReservationGetPriceCalendarEndpointReturnReservationNotfoundExceptionIntTest : BaseReservationEndpointIntTest
{
    [Fact]
    public async Task Reservation_GetBookingPriceCalendar_ReturnReservationNotfoundException()
    {
        ...
        var response = await Client.PostAsync(
            $"{BaseUrl}/{reservation.Id}/change-persons",
            payload
        );
