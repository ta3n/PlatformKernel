...
public class GetAllOptionItemsOfReservationEndpointIntTest : BaseReservationEndpointIntTest
{
    [Fact]
    public async Task GetAllOptionItems_ReturnOK_WithOptionItemResponse()
    {
