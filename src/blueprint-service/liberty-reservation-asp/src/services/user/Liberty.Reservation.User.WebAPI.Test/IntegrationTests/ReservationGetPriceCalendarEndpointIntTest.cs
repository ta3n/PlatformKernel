...
public class ReservationGetPriceCalendarEndpointIntTest : BaseReservationEndpointIntTest
{
    [Fact]
    public async Task Reservation_GetBookingPriceCalendar_ReturnOk_WithBookingPriceCalendarResponse()
    {
