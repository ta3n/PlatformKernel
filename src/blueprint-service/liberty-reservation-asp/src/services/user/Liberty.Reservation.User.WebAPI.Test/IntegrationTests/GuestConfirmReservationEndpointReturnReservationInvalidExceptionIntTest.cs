...
public class GuestConfirmReservationEndpointReturnReservationInvalidExceptionIntTest : BaseReservationEndpointIntTest
{
    private static new string BaseUrl => "api/guest/booking";

    [Fact]
    public async Task Guest_ConfirmReservation_ReturnReservationInvalidException()
    {
