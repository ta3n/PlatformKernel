...
public class ReservationGetAllPersonAgeTypesEndpointReturnReservationNotfoundExceptionIntTest : BaseReservationEndpointIntTest
{
    [Fact]
    public async Task Reservation_GetAllPersonAgeTypes_ReturnReservationNotfoundException()
    {
        ...
        var response = await Client.GetAsync($"{BaseUrl}/{reservation.Id + 1}/person-age-types");
