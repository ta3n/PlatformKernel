...
public class BookingAdjustCommandValidator : AbstractValidator<BookingChangeExecutionCommand>
{
    public BookingAdjustCommandValidator()
    {
        ...
        RuleFor(x => x.Payload.IsAgree)
            ...
            .WithMessage(ErrorCode.E2041.GetEnumDescriptions());
