...
public class RoomGroupCategoriesEndpointUnitTest : BaseCategoriesEndpointUnitTest
{
    [Fact]
    public async Task CreateRoomGroupCategory_ReturnsCorrectResult()
    {
        ...
        var controller = new RoomGroupCategoriesEndpoint(mockMapper, MockCategoryService);
