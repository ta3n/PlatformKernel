...
public class MealTypeCategoriesEndpointUnitTest : BaseCategoriesEndpointUnitTest
{
    [Fact]
    public async Task CreateMealTypeCategory_ReturnsCorrectResult()
    {
        // Arrange
        ...
        var controller = new MealTypeCategoriesEndpoint(mockMapper, MockMediator, MockCategoryService);
    ...
    [Fact]
    public async Task UpdateMealTypeCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnableMealTypeCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
        ...
        var controller = new MealTypeCategoriesEndpoint(mockMapper, mockMediator.Object, MockCategoryService);
        var cancellationToken = CancellationToken.None;
    ...
    [Fact]
    public async Task EnableMealTypeCategory_ReturnAppRequestInvalidException()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task DeleteMealTypeCategory_ReturnsCorrectResult()
    {
        // Arrange
        var categoryId = 2;
        var category = new Category
    ...
    [Fact]
    public async Task GetMealTypeCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task GetAllMealTypeCategories_ReturnsCorrectResult()
    {
        // Arrange
