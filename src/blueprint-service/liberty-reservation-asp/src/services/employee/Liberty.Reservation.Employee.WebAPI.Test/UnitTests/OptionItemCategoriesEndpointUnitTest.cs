...
public class OptionItemCategoriesEndpointUnitTest : BaseCategoriesEndpointUnitTest
{
    [Fact]
    public async Task CreateOptionItemCategory_ReturnsCorrectResult()
    {
        ...
        var controller = new OptionItemCategoriesEndpoint(mockMapper, MockCategoryService);
