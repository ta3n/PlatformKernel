...
public class FacilityEquipmentCategoriesEndpointUnitTest : BaseCategoriesEndpointUnitTest
{
    [Fact]
    public async Task CreateFacilityEquipmentCategory_ReturnsCorrectResult()
    {
        // Arrange
        ...
        var controller = new FacilityEquipmentCategoriesEndpoint(mockMapper, MockMediator, MockCategoryService);
    ...
    [Fact]
    public async Task UpdateFacilityEquipmentCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnableFacilityEquipmentCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
        ...
        var controller = new FacilityEquipmentCategoriesEndpoint(mockMapper, mockMediator.Object, MockCategoryService);
        var cancellationToken = CancellationToken.None;
    ...
    [Fact]
    public async Task EnableFacilityEquipmentCategory_ReturnAppRequestInvalidException()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task DeleteFacilityEquipmentCategory_ReturnsCorrectResult()
    {
        // Arrange
        var categoryId = 2;
        var category = new Category
    ...
    [Fact]
    public async Task GetFacilityEquipmentCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task GetAllFacilityEquipmentCategories_ReturnsCorrectResult()
    {
        // Arrange
