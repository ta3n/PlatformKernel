...
public class ViewCategoriesEndpointUnitTest : BaseCategoriesEndpointUnitTest
{
    [Fact]
    public async Task CreateViewCategory_ReturnsCorrectResult()
    {
        // Arrange
        ...
        var controller = new ViewCategoriesEndpoint(mockMapper, MockMediator, MockCategoryService);
    ...
    [Fact]
    public async Task UpdateViewCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnableViewCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
        ...
        var controller = new ViewCategoriesEndpoint(mockMapper, mockMediator.Object, MockCategoryService);
        var cancellationToken = CancellationToken.None;
    ...
    [Fact]
    public async Task EnableViewCategory_ReturnAppRequestInvalidException()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task DeleteViewCategory_ReturnsCorrectResult()
    {
        // Arrange
        var categoryId = 2;
        var category = new Category
    ...
    [Fact]
    public async Task GetViewCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task GetAllViewCategories_ReturnsCorrectResult()
    {
        // Arrange
