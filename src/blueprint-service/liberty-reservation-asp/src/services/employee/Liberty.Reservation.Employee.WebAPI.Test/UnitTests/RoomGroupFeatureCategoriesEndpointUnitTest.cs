...
public class RoomGroupFeatureCategoriesEndpointUnitTest : BaseCategoriesEndpointUnitTest
{
    [Fact]
    public async Task CreateRoomGroupFeatureCategory_ReturnsCorrectResult()
    {
        // Arrange
        ...
        var controller = new RoomGroupFeatureCategoriesEndpoint(mockMapper, MockCategoryService);
    ...
    [Fact]
    public async Task UpdateRoomGroupFeatureCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnableRoomGroupFeatureCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnableRoomGroupFeatureCategory_ReturnAppRequestInvalidException()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task DeleteRoomGroupFeatureCategory_ReturnsCorrectResult()
    {
        // Arrange
        var categoryId = 2;
        var category = new Category
    ...
    [Fact]
    public async Task GetRoomGroupFeatureCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task GetAllRoomGroupFeatureCategories_ReturnsCorrectResult()
    {
        // Arrange
