...
public class AmenityCategoriesEndpointUnitTest : BaseCategoriesEndpointUnitTest
{
    [Fact]
    public async Task CreateAmenityCategory_ReturnsCorrectResult()
    {
        // Arrange
        ...
        var controller = new AmenityCategoriesEndpoint(mockMapper, MockMediator, MockCategoryService);
    ...
    [Fact]
    public async Task UpdateAmenityCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task EnableAmenityCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
        ...
        var controller = new AmenityCategoriesEndpoint(mockMapper, mockMediator.Object, MockCategoryService);
        var cancellationToken = CancellationToken.None;
    ...
    [Fact]
    public async Task EnableAmenityCategory_ReturnAppRequestInvalidException()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task DeleteAmenityCategory_ReturnsCorrectResult()
    {
        // Arrange
        var categoryId = 2;
        var category = new Category
    ...
    [Fact]
    public async Task GetAmenityCategory_ReturnsCorrectResult()
    {
        // Arrange
        var category = new Category
        {
    ...
    [Fact]
    public async Task GetAllAmenityCategories_ReturnsCorrectResult()
    {
        // Arrange
