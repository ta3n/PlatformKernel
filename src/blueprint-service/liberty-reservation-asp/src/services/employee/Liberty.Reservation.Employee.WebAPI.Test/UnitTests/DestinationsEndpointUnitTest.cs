...
public class DestinationsEndpointUnitTest : BaseUnitTest
{
    ...
    {
        // Arrange
        var request = new DestinationCreateRequest("Destination 1", "Dest1", "https://example.com");
        var controller = new DestinationsEndpoint(MockMapper, MockMediator, MockCacheService, MockSiteService);
    ...
    {
        // Arrange
        var request = new DestinationUpdateRequest("Code 1", "Destination 1", "Des 1", "https://example.com");
        var controller = new DestinationsEndpoint(MockMapper, MockMediator, MockCacheService, MockSiteService);
