...
public class MasterCalendarUpdateTypeCommandValidator : AbstractValidator<MasterCalendarUpdateTypeCommand>
{
    public MasterCalendarUpdateTypeCommandValidator()
    {
        ...
        RuleFor(x => x.Payload.AppDateTypeId)
            .Cascade(CascadeMode.Stop)
            .NotNull()
            .WithErrorCode(ErrorCode.E0001)
            .NotEmpty()
