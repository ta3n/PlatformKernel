...
public class MasterCalendarDeleteDataCommandValidator : AbstractValidator<MasterCalendarDeleteDataCommand>
{
    public MasterCalendarDeleteDataCommandValidator()
    {
