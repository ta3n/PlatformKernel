...
public class Io10013Template(
    Io10013TemplateFormat format,
    SmtpMailSetting smtpMailSetting
) : BaseTemplate
{
    private SmtpMailSetting Settings { get; set; } = smtpMailSetting;
    private Io10013TemplateFormat Format { get; set; } = format;
    ...
    public override string Body
    {
        get
        {
            ...
            var isFacilityEmail = ReservationOperationType == ReservationOperationTypes.Facility;
            ...
            var args = new FormatDictionary
            {
                ...
                { "totalPersonDetail", TotalPersonsDetail(isFacilityEmail) },
                { "RoomGroupName", data?.RoomGroup.Name },
                { "PlanName", data?.Plan.Name },
                { "reservationDetail", ReservationDetail(isFacilityEmail) },
    ...
    public override void SetSample()
    {
        ...
        Reservation!.Facility!.Name = new MultilingualText
        {
            { LanguageHeaderUtil.GetLanguageCodeFromHeader(), Settings.FacilityNamePreview ?? "サンプル荘" }
        };
    }
}
