...
- [Libraries and Tools Use](#libraries-and-tools-use)
...
- **Liberty.Exception**: Contains classes and files related to exception handling within the Liberty Reservation
...
- **Liberty.OpenTelemetry**: Contains components related to OpenTelemetry, which is an open-source observability
  framework for cloud-native software. OpenTelemetry provides a set of APIs, libraries, agents, and instrumentation to
  enable the collection of distributed traces and metrics from applications.
...
- **Others**: Adds more plugins if need, such as: work with cache (Liberty.Caching), work with GMO (Liberty.GMO), work
  with message broker (Liberty.MassTransit), work with Elasticsearch (Liberty.Elastic), work with Sentry (
  Liberty.Sentry) v.v...
...
<img src="./docs/images/LibertySystemArchitect-ComponentArchitectureOfService.drawio.svg">
...
<img src="./docs/images/LibertySystemArchitect-LayerDependencies.drawio.svg">
...
<img src="./docs/images/LibertySystemArchitect-BusinessFlow.drawio.svg">
...
<img src="./docs/images/LibertySystemArchitect-NormalFlow.drawio.svg">

---

## Libraries and Tools Use

- Backend using .Net Core 8.0 (https://dotnet.microsoft.com/en-us/download/dotnet/8.0)
- Frontend using VueJS (https://vuejs.org/guide/introduction.html)
- SQL database with MySql 8.0.29 (https://www.mysql.com/)
- Data migration with EF (https://learn.microsoft.com/en-us/ef/core/managing-schemas/migrations/)
- Accessing database with EF (https://learn.microsoft.com/en-us/ef/core/what-is-new/ef-core-8.0/whatsnew)
- In-process messaging with MediatR (https://www.nuget.org/packages/MediatR)
- Polly (https://github.com/App-vNext/Polly)
-

OpenTelemetry (https://github.com/open-telemetry/opentelemetry-dotnet/blob/main/src/OpenTelemetry.Exporter.OpenTelemetryProtocol/README.md)

- ASP.NET API Versioning (https://github.com/dotnet/aspnet-api-versioning)
- Valid object with FluentValidation(https://github.com/FluentValidation/FluentValidation)
- Swagger (https://github.com/domaindrivendev/Swashbuckle.AspNetCore)
- Send mail with MailKit (https://github.com/jstedfast/MailKit) and MimeKit (https://github.com/jstedfast/MimeKit)
- Handle json with Newtonsoft.Json (https://www.newtonsoft.com/json)
- Application monitoring software with Sentry (https://docs.sentry.io/platforms/dotnet/)
- Apply .Net Aspire on local dev (https://learn.microsoft.com/en-us/dotnet/aspire/get-started/aspire-overview)
- Building Docker images, managing containers and registry (https://www.docker.com/)
...
<img src="./docs/images/git-convention.png">
