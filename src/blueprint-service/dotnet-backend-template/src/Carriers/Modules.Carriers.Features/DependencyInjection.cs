...
public static class CarriersModuleRegistration
{
	...
	public static IServiceCollection AddCarriersModule(
	...
	private static IServiceCollection AddCarriersModuleApi(
		this IServiceCollection services
	)
	{
		services.AddScoped<CarrierModuleApi>();

		services.AddScoped<ICarrierModuleApi>(
			provider =>
			{
...
{
	public IApplicationBuilder Configure(
