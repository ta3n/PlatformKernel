...
public abstract class BaseTest(
	CustomWebApplicationFactory webFactory
)
{
	...
	protected async Task<ShipmentResponse> CreateShipmentAsync(
	...
	protected async Task CreateStockAsync(
		string authToken,
		string productName,
		int quantity
	)
	...
	protected async Task CreateCarrierAsync(
		string authToken,
		string carrierName
	)
	{
