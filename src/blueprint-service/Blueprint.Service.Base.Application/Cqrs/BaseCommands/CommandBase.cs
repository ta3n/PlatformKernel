using SharedKernel.ApplicationShared.Cqrs;
using SharedKernel.ApplicationShared.Cqrs.BaseCommand;

namespace Blueprint.Service.Base.Application.Cqrs.BaseCommands;
